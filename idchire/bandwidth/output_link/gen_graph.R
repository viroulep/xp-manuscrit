...
frameall = read.table("./all_data_bandwidth_output_link.dat", header=TRUE)
...
pdf("link_output_saturation.pdf", width = 10, height=6)
...
myplot = myplot + scale_colour_discrete(name="Copie depuis le noeud 0")
